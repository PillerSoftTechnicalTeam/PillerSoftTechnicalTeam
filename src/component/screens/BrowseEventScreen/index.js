...
export default class BrowseEventScreen extends Component {
    ...
    render() {
        const { categoryName, data, eventCategoryData, pastEventData, futureEventData, isLoading } = this.state;
                ...
                <View style={{ backgroundColor: 'white', flex: 1 }}>
                    {/* <View style={{ flexDirection: 'row', marginStart: 15, marginEnd: 8 }}>
                        <Button
                            ...
                            customStyle={[{ width: 69, height: 26, backgroundColor: '#530D89', borderRadius: 5, }]}
                            titleStyle={{ fontSize: 10 }} />
                        <Button
                            title={'Your Group'}
                            onPress={() => alert('Under Development')}
                            customStyle={[{ width: 69, height: 26, backgroundColor: '#530D89', borderRadius: 5, marginStart: 3 }]}
                            titleStyle={{ fontSize: 10 }} />
                        <Button
                            title={'Discover'}
                            onPress={() => alert('Under Development')}
                    ...
                    <View style={{ marginStart: 10, marginEnd: 10 }}>
                        {eventCategoryData.length > 0 ? <FlatList
                            data={eventCategoryData}
                            extraData={eventCategoryData}
                            renderItem={this.renderItem}
                            horizontal={true}
                        /> :
                            <Text style={{ fontSize: 16, marginTop: 150, fontWeight: '900', textAlign: 'center' }}>{isLoading ? '' : 'No Events Found'}</Text>}
