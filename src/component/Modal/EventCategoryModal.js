...
class EventCategoryModal extends Component {
    ...
    selectGender(name,id) {
        this.setState({ name: name }, () => {
            this.props.parentReference(name,id)
        });
        this.toggleSelect();
    }
    ...
    renderItem = ({ item }) => {
        ...
        return (
            ...
            }} onPress={() => this.selectGender(item.CategoryName,item.Id)}>
                <Text style={{ marginStart: 15, color: '#530D89', fontSize: 16 }}>{item.CategoryName}</Text>
            </TouchableOpacity>
        )
    }
            ...
            <View>
                <TouchableOpacity
                    ...
                    <Text style={
                        ...
                        {this.state.name ? this.state.name : 'Choose Category'}
                    </Text>
                    {/* </View> */}
                ...
                <Modal
                    ...
                    <Content style={styles.rootContainerMain}>
                        <View style={{ marginTop: width / 1.5 }}>
                            <ListItem
                                bottomDivider
