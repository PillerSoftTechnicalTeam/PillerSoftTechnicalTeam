...
class InviteEventModal extends Component {
    ...
    onPressInvite = (id) => {
        ...
        console.log('EventId invite-->>', JSON.stringify(EventId))
                ...
                <Content style={styles.rootContainerMain}>
                    <View style={{ marginTop: 160, alignSelf: 'center', backgroundColor: 'white', width: width / 1, paddingStart: 10, }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20, borderBottomColor: '#B7B0B0', borderBottomWidth: 0.2, height: 50, marginEnd: 15 }}>
                            <Text style={{ fontSize: 24, flex: 1, textAlign: 'center' }}>Invite to Event</Text>
                        ...
                        <Text style={{ fontSize: 14, marginTop: 45, marginEnd: 10, marginStart: 10 }}>Enter the Email address to Invite a friend to join the event!</Text>
                        <View style={{
